...
add_action( 'admin_enqueue_scripts', 'admin_enqueue_style_script_func' );
 ...
 function admin_enqueue_style_script_func() {
    ...
    wp_enqueue_script( 'admin-script', get_stylesheet_directory_uri().'/admin/js/admin-script.js', array('jquery'), '1.0' );
	wp_localize_script( 'admin-script', 'site_var', array('ajaxurl' => admin_url( 'admin-ajax.php' )));
}
